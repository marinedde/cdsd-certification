...
### Kayak · [`bloc1-infrastructure-donnees/`](bloc1-infrastructure-donnees/)
...
### Speed Dating · [`bloc2-analyse-exploratoire/speed-dating/`](bloc2-analyse-exploratoire/speed-dating/)
...
### Steam · [`bloc2-analyse-exploratoire/steam/`](bloc2-analyse-exploratoire/steam/)
...
### Walmart Sales · [`bloc3-machine-learning/walmart/`](bloc3-machine-learning/walmart/)
...
### Conversion Rate · [`bloc3-machine-learning/conversion-rate/`](bloc3-machine-learning/conversion-rate/)
...
### North Face · [`bloc3-machine-learning/north-face/`](bloc3-machine-learning/north-face/)
...
### Getaround · [`bloc5-deployment/getaround/`](bloc5-deployment/getaround/)
...
### OncoPrint · [`bloc6-direction-projet/oncoprint/`](bloc6-direction-projet/oncoprint/)
...
cdsd-certification/
├── README.md
├── bloc1-infrastructure-donnees/
│   └── projet_kayak.ipynb
├── bloc2-analyse-exploratoire/
│   ├── speed-dating/
│   └── steam/
